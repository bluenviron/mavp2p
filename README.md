...
Install git and Go &ge; 1.26. Clone the repository, enter into the folder and start the building process:
...
On the machine you want to use to compile, install git and Go &ge; 1.26. Clone the repository, enter into the folder and start the building process:
